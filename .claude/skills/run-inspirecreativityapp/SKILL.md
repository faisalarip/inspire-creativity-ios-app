...
> at `.claude/skills/run-inspirecreativityapp/driver.sh`.
...
.claude/skills/run-inspirecreativityapp/driver.sh up
...
.claude/skills/run-inspirecreativityapp/driver.sh auth
...
```bash
D=.claude/skills/run-inspirecreativityapp/driver.sh

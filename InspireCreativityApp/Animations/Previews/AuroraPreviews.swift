...
enum AuroraDescriptors {
    ...
    static let all: [AuroraDescriptor] = {
        ...
        let raw: [D] = [
            ...
            ("au-arctic","Arctic Light","Atmospheric",.streaks,"arctic",7,false,nil,"Travel · weather apps",AuroraParticles(kind: .snow, density: 25, colorHex: nil)),
            ...
            ("au-foggy","Foggy Marsh","Atmospheric",.mesh,"mono",14,true,8.99,"Reading apps · podcast",nil),
            ...
            ("au-oilslick","Oil Slick","Iridescent",.spin,"oilSlick",10,false,nil,"Music · creative tools",nil),
            ...
            ("au-goldfoil","Gold Foil","Iridescent",.spin,"gold",18,false,nil,"Luxury · winner · awards",nil),
            ...
            ("au-nebula","Nebula Drift","Cosmic",.mesh,"nebula",16,false,nil,"Astrology · sci-fi",AuroraParticles(kind: .stars, density: 60, colorHex: nil)),
            ("au-solar","Solar Flare","Cosmic",.bloom,"solar",3,false,nil,"Big reveals · launch",nil),
            ...
            ("au-bokeh","Soft Bokeh","Particles",.mesh,"romantic",14,false,nil,"Wedding · photo apps",AuroraParticles(kind: .bokeh, density: 20, colorHex: "#FECDD3")),
            ...
            ("au-ringpulse","Ring Pulse","Geometric",.bloom,"tropics",2.5,true,8.99,"Tap target · live indicator",nil),
            ...
            ("au-liquiddrop","Liquid Drop","Liquid",.goo,"ocean",10,false,nil,"Water apps · meditation",nil),
            ...
            ("au-ethereal","Ethereal Mist","Mood",.mesh,"ethereal",16,true,8.99,"Meditation · spiritual",nil),
            ...
            ("au-velvetcalm","Velvet Calm","Mood",.mesh,"pastel",18,true,8.99,"Sleep · gentle reminders",nil),
